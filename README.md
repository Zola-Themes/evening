# Evening
Evening is a clean, responsive theme based on the Hugo theme with the same name featuring categories, tags and pagination.
...
## Installation
First download this theme to your `themes` directory, and then enable it in your `config.toml`:
